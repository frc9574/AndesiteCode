...
public class DriveIOSparkMax implements DriveIO {
  ...
  private final CANSparkMax leftLeader = new CANSparkMax(3, MotorType.kBrushless);
  private final CANSparkMax rightLeader = new CANSparkMax(1, MotorType.kBrushless);
  private final CANSparkMax leftFollower = new CANSparkMax(4, MotorType.kBrushless);
  private final CANSparkMax rightFollower = new CANSparkMax(2, MotorType.kBrushless);
